...
export default function Hero() {
  return (
    <>
      <div className="absolute top-0 z-[-1] h-screen w-full bg-grid-black/[0.1] dark:bg-grid-white/[0.1]">
      ...
      <section className="container relative z-40 mt-16 flex h-screen w-full flex-col max-md:px-4 md:mt-48 md:justify-start">
        <div className="flex flex-row items-center justify-between gap-5 md:items-start md:text-left">
          <div className="flex flex-col justify-center gap-3">
            ...
            <p className="max-w-lg text-lg dark:text-neutral-300">
              Enough with the paid solutions. You don’t need to spend money on a
              boilerplate just to build your startup in a week and fail. Great
              things take Great time.
            </p>
            <Button className="mt-4 gap-2 md:w-fit" size="lg">
